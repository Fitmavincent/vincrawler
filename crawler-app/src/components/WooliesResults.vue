  ...
  <div>
    ...
    <div class="channel-view">
      <div class="channel-heading">
        ...
        <span class="channel-badge">Woolies</span>
      </div>

      <div class="search-row">
        <SearchInput
          v-model="search"
          placeholder="Search Woolworths specials"
          @search="searchResult"
          @clear="searchResult">
      ...
      <div v-else-if="!isLoading" class="empty-state">
        ...
        <p>No Woolworths items match these filters.</p>
      </div>
    </div>
  </div>
</template>
...
.channel-heading {
  ...
  gap: 1rem;
  border: 1px solid rgba(23, 136, 65, 0.16);
  border-left: 0.35rem solid #178841;
...
.filter-toggle--active {
  border-color: rgba(23, 136, 65, 0.34);
  color: #047857;
  background: #ecfdf5;
}
...
.filter-toggle:focus-within {
  outline: 3px solid rgba(23, 136, 65, 0.18);
  outline-offset: 2px;
}
